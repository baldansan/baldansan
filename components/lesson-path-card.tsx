  ...
  return (
    <section className="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-emerald-200 sm:p-5">
      ...
      <ol className="mt-3 flex flex-col gap-2 sm:flex-row sm:gap-3">
        <li className="flex-1">
          <WatchLessonLink lessonId={lessonId} className={stepLinkClass}>
        ...
        <li className="flex-1">
          <Link href={lessonVocabularyPath(lessonId)} className={stepLinkClass}>
            <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-emerald-500 text-xs font-bold text-white">
              2
            </span>
            Vocabulary
        ...
        <li className="flex-1">
          <Link href={lessonQuizPath(lessonId)} className={stepLinkClass}>
            <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-emerald-500 text-xs font-bold text-white">
              3
            </span>
            Quiz
