...
function decisionLabel(value: LaunchDecisionValue): string {
  if (value === "launch_candidate") return "Гаргахад бэлэн";
...
export function LaunchDecisionCard({ decision, onSetDecision, onReset }: Props) {
  return (
    <section className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200 sm:p-6">
      <h2 className="text-lg font-semibold text-slate-900">Гаргах шийдвэр</h2>
      <p className="mt-2">
        <span
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        ...
        >
          Шалгах шаардлагатай гэж тэмдэглэх
        </button>
        <button
          type="button"
          onClick={onReset}
