...
import { getLessonActivityLog } from "@/lib/supabase/admin-activity-log";
...
export default async function AdminEditLessonPage({ params }: Props) {
  ...
  const lessonActivity = await getLessonActivityLog(normalizedId, 10);
