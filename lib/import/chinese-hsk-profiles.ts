...
export const HSK_PROFILES: Record<HskLessonProfileId, HskProfileDefinition> = {
  ...
  "hsk1-pronunciation-character-basic": {
    ...
    optionalSections: ["culture", "modelTest", "characters"],
    requiresQuiz: true,
  },
  "hsk2-basic-dialogue-sentence": {
    ...
    optionalSections: ["modelTest", "culture", "characters"],
    requiresQuiz: true,
  },
  "hsk3-dialogue-reading-writing-review": {
    ...
    optionalSections: ["dialogues", "shortReadings", "characters"],
    requiresQuiz: true,
  },
  "hsk4-dialogue-shorttext-exam-workbook": {
  ...
  "hsk5-article-topic-vocab-nuance-writing": {
    ...
    optionalSections: ["paragraphs", "characters"],
    requiresQuiz: true,
  },
  "hsk6-advanced-reading-output-summary": {
    ...
    optionalSections: ["paragraphs", "summaryPrompt", "characters"],
    requiresQuiz: true,
  },
};
